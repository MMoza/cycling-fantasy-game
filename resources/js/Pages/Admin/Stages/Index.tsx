...
export default function Index({ edition, stages }: { edition: { id: string; year: number; competition: string }; stages: Stage[] }) {
    return (
        <AdminLayout>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Button variant="ghost" size="icon" asChild>
                            <Link href={route('admin.competitions.editions.index', { competitionId: edition.id })}>
