                ...
                <div className="grid gap-4 md:grid-cols-3">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                            <CardTitle className="text-sm font-medium">Mis ligas</CardTitle>
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                            <CardTitle className="text-sm font-medium">Próxima etapa</CardTitle>
                            ...
                            {[
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <Badge variant="secondary" className="h-8 w-8 items-center justify-center rounded-full p-0">
                                            {stage.number}
                                        </Badge>
                                        <div>
